...
import { generarNumeroBoleta, generarBoletaPDF, enviarBoletaPorEmail } from "../../services/boletaService";
...
const InscripcionIndividual = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     // Generar el PDF de la boleta
       const boletaPDF = await generarBoletaPDF(estudiante, tutores, areasSeleccionadas, nuevoBoleta);
  ...
  // Envío automático de la boleta al correo del usuario
       const correoDestino = estudiante.correo_electronico;
          ...
          await enviarBoletaPorEmail(estudiante, tutores, areasSeleccionadas, nuevoBoleta, correoDestino);
